...
RUN_DIR="$ARTIFACTS_DIR/run/bootstrap/py"
...
write_bootstrap_config "$ORIGIN_DIR" test4-py-bootstrap-origin 38601 38602 Yes
write_bootstrap_config "$RELAY_B_DIR" test4-py-bootstrap-relay-b 38611 38612 No
write_bootstrap_config "$RELAY_C_DIR" test4-py-bootstrap-relay-c 38621 38622 No
...
echo "[4/4] Waiting for bootstrap TCP startup"
ready=0
for _ in {1..600}; do
...
echo "python bootstrap announce ring started"
...
echo "next: ./tests/hand/rnsd/test4/step4_rnid_bootstrap_py.sh"
